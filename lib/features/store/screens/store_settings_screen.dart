    ...
    if (widget.store.deliveryTime != null &&
      ...
      try {
        _minimumController.text =
            getDeliveryData(widget.store.deliveryTime!, 'min');
        _maximumController.text =
            getDeliveryData(widget.store.deliveryTime!, 'max');
                      ...
                      child: Column(children: [
                        ...
                        SizedBox(
                            height: isFood || isGrocery
                                ? Dimensions.paddingSizeDefault
                                : 0),
                        _module.vegNonVeg! && configModel.toggleVegNonVeg!
                            ? SwitchButtonWidget(
                                title: 'veg'.tr,
                        ...
                        isFood
                            ...
                            : const SizedBox(),
                        SizedBox(
                            height: isFood ? Dimensions.paddingSizeDefault : 0),
                        ...
                        SizedBox(
                            height: _store.selfDeliverySystem == 1
                                ? Dimensions.paddingSizeDefault
                                : 0),
                        isPharmacy && configModel.prescriptionOrderStatus!
                            ? SwitchButtonWidget(
                      ...
                      child: Column(children: [
                        ...
                        Padding(
                          ...
                          child: CustomTextFieldWidget(
                            hintText: 'eg_18'.tr,
                            labelText:
                                '${'gst_amount'.tr} (${configModel.currencySymbol})',
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('extra_packaging_charge'.tr,
                                        style: robotoRegular),
                                    Text(
                                        'extra_packaging_charge_description'.tr,
                                        style: robotoRegular.copyWith(
                                          fontSize: Dimensions.fontSizeSmall,
              ...
              child: CustomButtonWidget(
                ...
                onPressed: () {
                  ...
                  if (minimumOrder.isEmpty) {
                    ...
                    showCustomSnackBar(
                        'enter_maximum_delivery_charge_more_than_0'.tr);
                  } else if (_store.selfDeliverySystem == 1 &&
                      deliveryFee.isNotEmpty &&
                      maximumFee.isNotEmpty &&
                      double.parse(maximumFee) != 0 &&
                      (double.parse(deliveryFee) > double.parse(maximumFee))) {
                    showCustomSnackBar(
                    ...
                    _store.minimumOrder = minimumOrder.isNotEmpty
                    ...
                    _store.orderPlaceToScheduleInterval = _module
                        ...
                        : 0;
                    _store.minimumShippingCharge = deliveryFee.isNotEmpty
                        ? double.parse(deliveryFee)
                        : null;
                    _store.maximumShippingCharge =
                        maximumFee.isNotEmpty ? double.parse(maximumFee) : null;
                    _store.perKmShippingCharge = deliveryChargePerKm.isNotEmpty
                    ...
                    _store.minimumStockForWarning =
                        minimumStockForWarning.isNotEmpty
                            ...
                            : 0;
                    _store.enableUSD = storeController.isUSDEnabled;
