...
class _AddItemScreenState extends State<AddItemScreen>
  ...
  void initState() {
    ...
    if (_update) {
      ...
      storeController.setDiscountTypeIndex(
          _item.discountType == 'percent' ? 0 : 1, false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          CustomAppBarWidget(title: _update ? 'update_item'.tr : 'add_item'.tr),
      floatingActionButton: Get.find<SplashController>()
              .configModel!
              .openAiStatus!
          ? Padding(
            ...
            return GetBuilder<StoreController>(builder: (storeController) {
                  ...
                  categoryList.add(DropdownItem<int>(
                      ...
                      child: SizedBox(
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child:
                              Text(categoryController.categoryList![i].name!),
                        ),
                      )));
                }
              }
                  ...
                  suitableTagList.add(DropdownItem<int>(
                      ...
                      child: SizedBox(
                        child: Padding(
                          padding: const EdgeInsets.all(8.0),
                          child:
                              Text(storeController.suitableTagList![i].name!),
                        ),
                      )));
                }
              }
              ...
              if (storeController.allergicIngredientsSuggestionList != null) {
                for (int index = 0;
                    index <
                        storeController
                            .allergicIngredientsSuggestionList!.length;
                    index++) {
                                        ...
                                        ? InkWell(
                                            onTap: () {
                                              if (_nameControllerList[
                                                ...
                                                aiController
                                                    .generateTitleAndDes(
                                                  title: _nameControllerList[
                                                          _tabController!.index]
                                                      .text
                                                      .trim(),
                                                  langCode: _languageList![
                                                          _tabController!.index]
                                                      .key!,
                                                )
                                                    .then((value) {
                                              ...
                                              if (_nameControllerList[0]
                                                ...
                                                showCustomSnackBar(
                                                    'food_name_required_for_en'
                                                        .tr);
                                              } else if (_descriptionControllerList[
                                                      0]
                                                  .text
                                                  .isEmpty) {
                                                showCustomSnackBar(
                                                            ...
                                                            child: Row(
                                                                children: [
                                                                  ...
                                                                  InkWell(
                                                                    onTap: () =>
                                                                        storeController
                                                                            .removeAllergicIngredients(index),
                                                                    child:
                                                                        Padding(
                                                                      padding: const EdgeInsets
                                                                          .all(
                      ...
                      Container(
                        ...
                        child: CustomButtonWidget(
                          ...
                          onPressed: () {
                            ...
                            if (defaultDataNull) {
                            ...
                            } else if (categoryController.selectedCategoryID ==
                                null) {
                              ...
                              _item.categoryIds!.add(CategoryIds(
                                  id: categoryController.selectedCategoryID));
                              if (categoryController.selectedSubCategoryID !=
                                  null) {
                                _item.categoryIds!.add(CategoryIds(
